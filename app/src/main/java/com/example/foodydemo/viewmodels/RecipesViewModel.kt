...
import com.example.foody.util.Constants.Companion.DEFAULT_RECIPES_NUM
...
import com.example.foodydemo.data.DataStoreRepository
...
class RecipesViewModel @ViewModelInject constructor(
    ...
    fun applyQueries(): HashMap<String, String> {
        ...
        queries[QUERY_NUMBER] = DEFAULT_RECIPES_NUM
